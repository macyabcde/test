<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoPower.aspx.cs" Inherits="User.Web.other.Nopower" %>
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr height="400px;">
                        <td>
                            <img src="../images/noPower.jpg" alt="对不起，您还未开通此权限！" title="对不起，您还未开通此权限！" />
                        </td>
                    </tr>
                </table>
                <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
