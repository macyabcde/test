<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoveDepartment.aspx.cs"
    Inherits="User.Web.UserDepartManage.MoveDepartment" %>
...
<body>
                        ...
                        <td align="left" class="mo_title_l41">
                            <table width="200" border="0" cellspacing="1" cellpadding="0">
                                <tr>
                                    ...
                                    <td width="176">
                                        <asp:Label ID="lbwhatDo" runat="server" Text="组织移动"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
    ...
    <table width="400" border="0"  cellpadding="0" cellspacing="1">
        <tr height="5px"></tr>
        <tr>
            <td height="500px" align="left" valign="top">
...
<script language="javascript" type="text/javascript">
    ...
    var departID = document.getElementById("HFdepartID").value; //当前要移动的组织ID
    ...
    //初始化树，使当前要移动的组织的名称样式变为蓝色并加上“(要移动的组织)”的文字信息
    //DepartID：当前要移动的组织ID
    function intItTree(departID) {
        ...
        $("body").find("a").each(function(i, j) {
            ...
            if (j.href.getQuery("departID") == departID && j.innerText != "") {
                j.style.color = "blue";
                j.innerText = j.innerText + "(要移动的组织)";
        ...
        if (ifSelectOver) {
            ...
            $("body").find("a").each(function(i, j) {
                ...
                if (j.href.getQuery("departID") == moveToDeaprtID && j.innerText != "") {
                    if (moveToDeaprtID != departID && moveToDeaprtID != fatherID) {
                        oldNodeName = j.innerText;
                        //nodeHref=j.href;
                        j.style.color = "red";
                        j.innerText = j.innerText + "(移动到此组织)";
                        node = j;
                        //记录目标组织ID
