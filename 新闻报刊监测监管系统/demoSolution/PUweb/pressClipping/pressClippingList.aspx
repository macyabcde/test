<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pressClippingList.aspx.cs"
    Inherits="PU.web.pressClipping.pressClippingList" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        */
        function tjsp(pressClippingBasisInfoID, pressClippingName) {
            if (!confirm("您确认要将[" + pressClippingName + "]提交审批吗？")) return
                                        ...
                                        <td align="left" class="mo_title_l4">
                                            <table width="500" border="0" cellspacing="1" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="176">
                                                        <span class="mo_title_l31">剪报制作</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                    ...
                    <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0" style="font-size: 12px;">
                        <tr>
                            ...
                            <td align="right" height="40">
                                <asp:Button ID="BtAdd" runat="server" Text="新增剪报" CssClass="btn-btn01" OnClientClick="windOpen('pressClippingAdd.aspx?whatDo=add','760','430');return false;"/>
                                &nbsp;
                            </td>
                        </tr>
                    </table>
                            ...
                            <ItemTemplate>
                                <tr class="trData">
                                    ...
                                    <td align="center">
                                        ...
                                        <asp:HyperLink ID="HLinkTJSP" runat="server"  Text="提交审批" EnableViewState="False"></asp:HyperLink>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
