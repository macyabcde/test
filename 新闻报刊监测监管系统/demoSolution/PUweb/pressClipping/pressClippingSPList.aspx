<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pressClippingSPList.aspx.cs" Inherits="PU.web.pressClipping.pressClippingSPList" %>
                                        ...
                                        <td align="left" class="mo_title_l4">
                                            <table width="500" border="0" cellspacing="1" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="176">
                                                        <span class="mo_title_l31">剪报审批</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                            ...
                            <ItemTemplate>
                                <tr class="trData">
                                    ...
                                    <td align="center">
                                        ...
                                        <asp:HyperLink ID="HLinkSP" runat="server"  Text="审批" EnableViewState="False"></asp:HyperLink>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
