...
JQ(document).ready(function() {
    ...
    for (i = 0; i < JQ("#main-ed-articlenav-list div").length; i++) {
        ...
        //alert(ediall[0] + "," + ediall[1] + " edid[i]=" + edid[i] + " edifm[i]=" + edifm[i]);
        if (ediall[0].Trim() != "") {
...
(function(JQ) {
    ...
    shape_from_area = function(area) {
        ...
        //href = href.match(re);
        var href = area.getAttribute('btID');      
    ...
    JQ.fn.maphilight = function(opts) {
        ...
        return this.each(function() {
            ...
            mouseover = function(e) {
                ...
                var thisedifb = "";
                var currentid = null;
                //alert("shape[0]=" + shape[0] + "shape[1]=" + shape[1] + "shape[2]=" + shape[2]);
