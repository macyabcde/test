<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="allPaper.aspx.cs" Inherits="PU.web.PaperLook.allPaper" %>
            ...
            <tr>
                ...
                <td valign="top">
                                        ...
                                        <td align="left" class="mo_title_l4">
                                            <table width="200" border="0" cellspacing="1" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="176">
                                                        <span class="mo_title_l31">报刊大全</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                    ...
                    <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0" class="divcss5-6">
                        <tr>
                            <td height="34" style="text-align:left; padding-left:14px;">
                                关键词：<asp:TextBox ID="txtKey" runat="server" title="可输入：报纸名称、报纸ID、报纸名称拼音首字母缩写"></asp:TextBox>
                                &nbsp;<asp:Button ID="BtSearch" runat="server" CssClass="btn-btn01" Text="查 询" title="根据输入的关键词查询报纸"/>
                            </td>
                        </tr>
                    </table>
                    <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
