<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="provincePaper.aspx.cs"
    Inherits="PU.web.PaperLook.provincePaper" %>
            ...
            <tr>
                ...
                <td valign="top">
                                        ...
                                        <td align="left" class="mo_title_l4">
                                            <table width="200" border="0" cellspacing="1" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="176">
                                                        <span class="mo_title_l31">报刊地域</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                    ...
                    <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0" class="divcss5-6">
                        <tr>
                            <td height="30" align="left" class="divcss5-6">                                                            
                                <div id="Div1" >
                                    
                                        <% for (int i = 0; i < dt_province.Rows.Count; i++)
                                           {
                                               string color = "#000000";
                                               if (dt_province.Rows[i]["dictionaryInfoID"].ToString() == province.ToString()) color = "#FF6600;";
                                                   
                                        %>
                                        <div style="height:20px; width:50px;float: left;text-align:left;"><a style="color: <%=color%>" href="provincePaper.aspx?province=<%=dt_province.Rows[i]["dictionaryInfoID"].ToString()%>">
                                            <%=dt_province.Rows[i]["dictionaryName"].ToString()%></a>
                                        </div>                                         
                                        <% } %>
